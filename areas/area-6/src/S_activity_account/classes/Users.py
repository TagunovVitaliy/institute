...
class User:
    ...
    def __init__(self, id, name,  individual_plans: List[IndividualPlan] = None):
        self.id = id
        self.name = name
        self.individual_plans = individual_plans[:] if individual_plans else []
        if not (
    ...
    def get_i_plans(self) -> List[IndividualPlan]:
    ...
    def set_i_plans(self, i_plans: List[IndividualPlan]):
