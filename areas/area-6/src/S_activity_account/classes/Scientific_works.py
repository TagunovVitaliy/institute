...
import datetime
from classes.Enums import ScientificWorkType
from classes.Enums import ScientificWorkStatus

class ScientificWork:
    def __init__(self, id, name, point, term_date, actual_date, type, status):
        self.id = id
        self.name = name
        self.point = point
